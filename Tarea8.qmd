...
:::{.proof}
Sea $\{0=t_{0},t_{1},\dots,t_{L-1},t_{L}=T\}$ una particion del intervalo $[0,T]$, de la aproximación de la suma de Riemann ecuación (@eq-aproximacionRiemann), se satisface que,
\begin{eqnarray*}
